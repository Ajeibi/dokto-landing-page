...
import { useRejectPrescription } from "@/api/dashboard/prescription/doctor-prescription";
...
export function RejectPrescriptionModal({
  ...
  const { mutateAsync: rejectPrescription, isPending } =
  ...
  const handleSubmitReason = async () => {
    ...
    rejectPrescription(payload).then(() => {
      onOpenChange(false);
      ...
      <DialogContent className="gap-7">
        ...
        <div className="w-full overflow-x-hidden">
          <div className="space-y-2 mb-12 px-3">
            ...
            >
              Enter the reason for disapproving this drug
            </Label>
            <Textarea
              id="reason"
              placeholder="Reason"
