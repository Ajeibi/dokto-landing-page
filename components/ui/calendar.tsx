  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-[#3B008F] text-white hover:bg-neutral-900 hover:text-white focus:bg-[#3B008F] focus:text-white",
        day_today: "text-text",
        day_outside:
          "day-outside text-white opacity-50 aria-selected:bg-neutral-100/50 aria-selected:text-white aria-selected:opacity-30",
        day_disabled: "text-text bg-gray-50",
        day_range_middle:
